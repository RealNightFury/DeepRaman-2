...
name=['B. subtilis.csv','Chitin.csv','E. coli EH100.csv','E. coli J5.csv','E. coli O11B4.csv',
      'E. coli O128B12.csv','F. tularensis LVS.csv','H. pylori GU2.csv','M. catarrhalis.csv',
      'P. aeruginosa.csv','S. aureus.csv','S. meliloti.csv','S. minnesota.csv','S. typhimurium.csv']
...
np.save('./latent data/ct',ct)
np.save('./latent data/cv',cv)
...
resnet50_model.compile(loss=['CategoricalCrossentropy'], optimizer=Adam(learning_rate=1e-4),metrics=['acc'])
